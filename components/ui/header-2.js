...
// Simple Button component (fallback if import fails)
const Button = React.forwardRef(({ children, className = '', variant = 'default', size = 'default', onClick, ...props }, ref) => {
...
function Header({ user, onSignOut, loading = false }) {
